    ...
    <div className="flex flex-col h-screen bg-gray-950 text-gray-100">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-80 flex-shrink-0 flex flex-col border-r border-gray-800 overflow-hidden">
          ...
          {/* Problem description (scrollable upper section) */}
          <div className="flex-1 overflow-y-auto p-4 border-b border-gray-800/60">
          ...
          {/* AI Chat section (lower section, shown when AI mode is on) */}
          <div className="flex-shrink-0 flex flex-col" style={{ maxHeight: '50%' }}>
            {/* AI mode toggle bar */}
            ...
            {practice.aiMode === 'chat' && (
              <>
                <div className="flex-1 overflow-y-auto p-3 min-h-0 max-h-48">
                  {practice.messages.length === 0 ? (
                    <p className="text-gray-600 text-xs">
                      Ask for a hint, request an analysis of your code, or discuss trade-offs between solutions.
                    </p>
                  ) : (
                    <ChatTranscript
